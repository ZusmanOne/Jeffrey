...
SECRET_KEY = 'django-insecure-b1+glm9lmg0a!_@m=)!xofh1&d8uh%zg=kq2lh820bi(0_!g-e'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'Flat/templates'),
                 ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "main/static", 'news/static'),
]
